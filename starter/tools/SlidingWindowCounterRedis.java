 ...
 */
public final class SlidingWindowCounterRedis<T> implements Serializable {

  private static final long serialVersionUID = -2645063988768785810L;

  private SlotBasedCounterRedis<T> objCounter;
  private int objSlot;
 ...
 public SlidingWindowCounterRedis(int num_stor,int freq) {
    if (num_stor < 3) {
    ...
    this.objCounter = new SlotBasedCounterRedis<T>(this.num_stor);
