...
public class SumBolt extends BaseRichBolt {
  ...
  public SumBolt(int num_stor,int freq){
    if (num_stor < 3) {
  ...
  public void execute(Tuple tuple) {
	...
	for (Object obj : objToCounts.keySet()) {
		collector.emit(new Values(obj,humanrealtime,deloldkeytime,getCount(obj,slot)));
	}
//	try{
...
//		}
 ...
 public String getCount(Object obj, int slot) {
  ...
  public void declareOutputFields(OutputFieldsDeclarer declarer) {
	declarer.declare(new Fields("obj", "actualtime","olddeltime","count"));
  }
